...
public struct TakeVector3<Vector: Vector3Type> {
    ...
    /// Gets a new `SubVector2` with the coordinates of `x`, `y`, in that order.
    @_transparent
    public var xy: SubVector2 {
        .init(x: underlying.x, y: underlying.y)
    }
    
    /// Gets a new `SubVector2` with the coordinates of `y`, `x`, in that order.
    @_transparent
    public var yx: SubVector2 {
        .init(x: underlying.y, y: underlying.x)
    }
    
    /// Gets a new `SubVector2` with the coordinates of `x`, `z`, in that order.
    @_transparent
    public var xz: SubVector2 {
        .init(x: underlying.x, y: underlying.z)
    }
    
    /// Gets a new `SubVector2` with the coordinates of `z`, `x`, in that order.
    @_transparent
    public var zx: SubVector2 {
        .init(x: underlying.z, y: underlying.x)
    }
    
    /// Gets a new `SubVector2` with the coordinates of `y`, `z`, in that order.
    @_transparent
    public var yz: SubVector2 {
        .init(x: underlying.y, y: underlying.z)
    }
    
    /// Gets a new `SubVector2` with the coordinates of `z`, `y`, in that order.
    @_transparent
