...
public struct RectangleT<Scalar: VectorScalar>: Equatable, Codable {
    ...
    @inlinable
    public func withLocation(_ location: Vector2<Scalar>) -> RectangleT {
    ...
    /// Returns a Rectangle that matches this Rectangle's size with a new location
    @inlinable
    public func withSize(_ size: Vector2<Scalar>) -> RectangleT {
    ...
    @inlinable
    public func scaledBy(vector: Vector2<Scalar>) -> RectangleT {
    ...
    @inlinable
    public func offsetBy(_ vector: Vector2<Scalar>) -> RectangleT {
...
public extension RectangleT where Scalar: DivisibleArithmetic {
    ...
    @inlinable
    func inflatedBy(_ size: Vector2<Scalar>) -> RectangleT {
        if size == .zero {
            return self
        }
    ...
    @inlinable
    func insetBy(_ size: Vector2<Scalar>) -> RectangleT {
        if size == .zero {
            return self
        }
    ...
    @inlinable
    func movingCenter(to center: Vector2<Scalar>) -> RectangleT {
...
public extension RectangleT {
    ...
    /// on the X and Y axis.
    func rounded(radius: Vector2<Scalar>) -> RoundRectangleT<Scalar> {
