...
public struct Rectangle2<Vector: Vector2Type> {
    ...
    public func movingTop(to value: Scalar) -> Rectangle2 {
        return Rectangle2(x: left, y: value, width: width, height: height)
    }
    ...
    public func movingLeft(to value: Scalar) -> Rectangle2 {
        return Rectangle2(x: value, y: top, width: width, height: height)
    }
...
public extension Rectangle2 where Scalar: AdditiveArithmetic {
    ...
    @inlinable
    func movingBottom(to value: Scalar) -> Rectangle2 {
    ...
    @inlinable
    func movingRight(to value: Scalar) -> Rectangle2 {
    ...
    /// instance, where the `top` lays on `value`.
    @inlinable
    func stretchingTop(to value: Scalar) -> Rectangle2 {
    ...
    /// instance, where the `bottom` lays on `value`.
    @inlinable
    func stretchingBottom(to value: Scalar) -> Rectangle2 {
    ...
    /// instance, where the `left` lays on `value`.
    @inlinable
    func stretchingLeft(to value: Scalar) -> Rectangle2 {
    ...
    /// instance, where the `right` lays on `value`.
    @inlinable
    func stretchingRight(to value: Scalar) -> Rectangle2 {
