...
public struct RoundRectangle2<Vector: Vector2Type> {
    ...
    public var bounds: Rectangle2<Vector>
    public var radius: Vector
    
    public init(bounds: Rectangle2<Vector>, radius: Vector) {
        self.bounds = bounds
        self.radius = radius
    }
    
    public init(bounds: Rectangle2<Vector>, radiusX: Scalar, radiusY: Scalar) {
        self.bounds = bounds
