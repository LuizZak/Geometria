...
class Periodic2GeometryTests: XCTestCase {
    func testClampedSimplexes_lines() {
        ...
        TestFixture.beginFixture { fixture in
            ...
            fixture.assertEquals(result, [
                .lineSegment2(
                    .init(
                        lineSegment: .init(start: .init(x: -12.360679774997932, y: 38.04226065180616),
        ...
        TestFixture.beginFixture(renderScale: 2) { fixture in
            fixture.assertions(on: lhs)
                .assertIntersections(rhs, [
                    ...
                    (self: 0.7850988328850047, other: 0.7907585000218638),
    ...
    func testAllIntersectionPeriods_lines_arcs_vertexIntersections_infiniteTolerance() {
        ...
        TestFixture.beginFixture(renderScale: 2) { fixture in
            fixture.assertions(on: lhs)
                .assertIntersections(rhs, tolerance: .infinity, [
                    (self: 2.2204460492503132e-17, other: 8.308813937217956e-18),
