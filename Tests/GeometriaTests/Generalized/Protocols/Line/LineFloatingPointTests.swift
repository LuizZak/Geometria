...
class LineFloatingPointTests: XCTestCase {
    ...
    func testProjectedNormalizedMagnitude() {
        ...
        assertEqual(
            sut.projectedNormalizedMagnitude(0.5),
            Vector2D(x: 2.5, y: 1.5),
            accuracy: 1e-12
        )
    }
    ...
    func testSignedDistance_line() {
        ...
        XCTAssertEqual(
            sut.signedDistance(to: Vector3D(x:  5, y: 2, z: 3)),
            0.0
        )
        XCTAssertEqual(
            sut.signedDistance(to: Vector3D(x: -5, y: 0, z: 0)),
            3.605551275463989
        )
        XCTAssertEqual(
            sut.signedDistance(to: Vector3D(x:  5, y: 0, z: 0)),
        ...
        XCTAssertEqual(
            sut.signedDistance(to: Vector3D(x: 15, y: 0, z: 0)),
            3.605551275463989
        )
    }
